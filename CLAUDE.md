...
**Stand 19.09.2026** · App (`index.html`) v0.18.0 · Apps Script (`apps-script/Code.js`) v0.19.0 · Veröffentlichen per GitHub Action (`.github/workflows/apps-script.yml`) v1.0.0
